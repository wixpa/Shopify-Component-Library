...
<style>
    ...
    * {
    ...
    @media (max-width: 768px) {
        ...
        /* Hide desktop heading inside accordion columns on mobile */
    ...
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-col footer-col--brand">
                <a href="${config.brandUrl}" class="brand-logo">${config.brandText}</a>
                <p class="brand-desc">${config.brandDescription}</p>
                <div class="social-icons">
                    ...
                    <a href="${config.xUrl}" class="social-link" aria-label="X"><i class="fab fa-x-twitter"></i></a>
            ...
            <div class="footer-col footer-col--accordion">
                <h3 class="footer-heading">${config.deliveryHeading}</h3>
                <button class="accordion-trigger" aria-expanded="false" aria-controls="accordion-delivery">
                    ${config.deliveryHeading}
                    <i class="fa-solid fa-chevron-down accordion-icon"></i>
                </button>
                <div class="accordion-body" id="accordion-delivery" role="region">
                    <ul class="footer-links">
                        <li><a href="${config.shippingUrl}">${config.shippingLabel}</a></li>
                        <li><a href="${config.returnsUrl}">${config.returnsLabel}</a></li>
                        <li><a href="${config.trackUrl}">${config.trackLabel}</a></li>
                        <li><a href="${config.faqUrl}">${config.faqLabel}</a></li>
                    </ul>
                </div>
            </div>

            <!-- About Enterprise Column -->
            <div class="footer-col footer-col--accordion">
                <h3 class="footer-heading">${config.aboutHeading}</h3>
                ...
                <div class="accordion-body" id="accordion-about" role="region">
                    <ul class="footer-links">
                        <li><a href="${config.aboutUsUrl}">${config.aboutUsLabel}</a></li>
                        <li><a href="${config.brandsUrl}">${config.brandsLabel}</a></li>
                        <li><a href="${config.adviceUrl}">${config.adviceLabel}</a></li>
                        <li><a href="${config.contactUrl}">${config.contactLabel}</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="footer-bottom">
            ...
            <div class="bottom-right">
                <ul class="policy-links">
                    <li><a href="${config.privacyUrl}">${config.privacyLabel}</a></li>
                    <li><a href="${config.shippingPolicyUrl}">${config.shippingPolicyLabel}</a></li>
                    <li><a href="${config.faqsUrl}">${config.faqsLabel}</a></li>
                    <li><a href="${config.returnsPolicyUrl}">${config.returnsPolicyLabel}</a></li>
                </ul>
                ...
                <div class="payment-icons">
                    ...
                    <div class="payment-icon" title="Mastercard">
                        <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <circle cx="24" cy="12" r="7" fill="#F79E1B" fill-opacity="0.8"/>
                    ...
                    <div class="payment-icon" title="Discover">
                        <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg">
                            <rect width="38" height="24" fill="white"/>
                            <text x="50%" y="55%" dominant-baseline="middle" text-anchor="middle" font-family="Arial, sans-serif" font-weight="bold" font-size="10" fill="#FF6600">DISCOVER</text>
                        </svg>
                    </div>
                </div>
            </div>
...
<script>
    document.querySelector('.newsletter-form').addEventListener('submit', function(e) {
        ...
        if (input.value) {
            ...
            input.value = '${config.newsletterSuccessMessage}';
            input.disabled = true;
            setTimeout(() => {
