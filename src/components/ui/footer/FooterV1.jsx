...
export function getFooterV1Code(config) {
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .newsletter-submit:hover { transform: translateY(-50%) translateX(3px); }
  ...
  .policy-links a:hover { color: var(--text-color); }
  ...
  @media (max-width: 768px) {
    ...
    .container { padding: 0; }
    .footer-col--brand { padding: 0 24px 30px; border-bottom: 1px solid var(--border-color); }
    .footer-grid { display: flex; flex-direction: column; gap: 0; margin-bottom: 0; }
    .social-icons { gap: 24px; }
    .social-link { font-size: 1.6rem; }
    .footer-col--accordion { border-bottom: 1px solid var(--border-color); }
    ...
    .accordion-body.is-open { max-height: 400px; padding: 0 24px 20px; }
    .footer-col--accordion .footer-heading { display: none; }
    ...
    .bottom-right { align-items: flex-start; width: 100%; }
  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-col footer-col--brand">
        <a href="#" class="brand-logo">${config.brandName}</a>
        <p class="brand-desc">${config.brandDesc}</p>
        <div class="social-icons">
          <a href="${config.facebookUrl}" class="social-link" aria-label="Facebook"><i class="fab fa-facebook"></i></a>
          <a href="${config.instagramUrl}" class="social-link" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
          <a href="${config.twitterUrl}" class="social-link" aria-label="X"><i class="fab fa-x-twitter"></i></a>
          <a href="${config.linkedinUrl}" class="social-link" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
          <a href="${config.threadsUrl}" class="social-link" aria-label="Threads"><i class="fab fa-threads"></i></a>
        </div>
      </div>

      <!-- Delivery & Returns Column -->
      <div class="footer-col footer-col--accordion">
        <h3 class="footer-heading">${config.col2Heading}</h3>
        <button class="accordion-trigger" aria-expanded="false" aria-controls="accordion-delivery">
          ${config.col2Heading}
          <i class="fa-solid fa-chevron-down accordion-icon"></i>
        </button>
        <div class="accordion-body" id="accordion-delivery" role="region">
      ...
      <!-- About Column -->
      <div class="footer-col footer-col--accordion">
        <h3 class="footer-heading">${config.col3Heading}</h3>
        <button class="accordion-trigger" aria-expanded="false" aria-controls="accordion-about">
          ${config.col3Heading}
          <i class="fa-solid fa-chevron-down accordion-icon"></i>
        </button>
        <div class="accordion-body" id="accordion-about" role="region">
          <ul class="footer-links">
            <li><a href="#">${config.col3Link1}</a></li>
            <li><a href="#">${config.col3Link2}</a></li>
            <li><a href="#">${config.col3Link3}</a></li>
      ...
      <!-- Newsletter Column -->
      <div class="footer-col footer-col--accordion">
        <h3 class="footer-heading">${config.newsletterHeading}</h3>
        <button class="accordion-trigger" aria-expanded="false" aria-controls="accordion-newsletter">
          ${config.newsletterHeading}
          <i class="fa-solid fa-chevron-down accordion-icon"></i>
        </button>
        <div class="accordion-body" id="accordion-newsletter" role="region">
          <p class="newsletter-text">${config.newsletterText}</p>
          <form class="newsletter-form" onsubmit="event.preventDefault();">
            <input type="email" class="newsletter-input" placeholder="${config.newsletterPlaceholder}" required aria-label="Email address">
    ...
    <div class="footer-bottom">
      <div class="copyright">${config.copyrightText}</div>
      <div class="bottom-right">
        ...
        <div class="payment-icons">
          <div class="payment-icon" title="Visa">
            <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg"><rect width="38" height="24" fill="white"/><path d="M15.4 15.8L16.5 9.2H18.2L17.1 15.8H15.4ZM22.6 15.8L21.8 11.5C21.8 11.5 21.6 10.8 21.6 10.8C21.5 10.4 21.4 10.3 21.2 10.2C20.9 10.1 20.4 10 20.1 10H19.5L19.2 11.3L20.6 15.8H22.6ZM24.4 15.8L25.9 9.2H24.3C24 9.2 23.8 9.3 23.7 9.6L22.2 13.2L21.4 9.2H19.7L21.7 15.8H24.4ZM13.4 9.2L12.1 14.1C12 14.3 12 14.4 11.9 14.4C11.8 14.5 11.2 14.3 10.9 14.1L10.1 11.1C10.1 11.1 9.8 10 9.8 10C9.7 9.7 9.6 9.4 9.6 9.2H7.9C7.9 9.2 8.8 12.6 9.2 14.1C9.4 14.6 9.6 15.1 10.1 15.4C10.5 15.7 11.2 15.9 11.8 15.9C12.5 15.9 13.1 15.6 13.4 15.2C13.6 14.9 13.7 14.6 13.8 14.2L15.1 9.2H13.4Z" fill="#1A1F71"/></svg>
          </div>
          <div class="payment-icon" title="Mastercard">
            <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg"><rect width="38" height="24" fill="white"/><circle cx="14" cy="12" r="7" fill="#EB001B"/><circle cx="24" cy="12" r="7" fill="#F79E1B" fill-opacity="0.8"/><path d="M19 16.5C17.5 16.5 16.1 15.9 15.1 14.9C14.1 13.9 13.5 12.5 13.5 11C13.5 9.5 14.1 8.1 15.1 7.1C16.1 6.1 17.5 5.5 19 5.5C20.5 5.5 21.9 6.1 22.9 7.1C23.9 8.1 24.5 9.5 24.5 11C24.5 12.5 23.9 13.9 22.9 14.9C21.9 15.9 20.5 16.5 19 16.5Z" fill="#FF5F00"/></svg>
          </div>
          <div class="payment-icon" title="American Express">
            <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg"><rect width="38" height="24" fill="#006FCF"/><path d="M5 16H8L9 14H12L13 16H16L12 7H9L5 16ZM9.5 12L10.5 9L11.5 12H9.5ZM17 7H21L22 9L23 7H27L25 11L27 16H23L22 13L21 16H17V7ZM19.5 9V10.5H21L20.5 9H19.5ZM19.5 12V14H21L21.5 12H19.5ZM28 7H34V9H30V10.5H33V12.5H30V14H34V16H28V7Z" fill="white" transform="scale(0.8) translate(4, 3)"/></svg>
          </div>
          <div class="payment-icon" title="PayPal">
            <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg"><rect width="38" height="24" fill="white"/><path d="M12.5 7.5H16.8C19.2 7.5 20.5 8.6 20.5 10.8C20.5 12.5 19.5 13.8 17.8 14.2L17.2 14.2L16.5 18.5H13.5L14.5 12.5H12.5L12.5 7.5Z" fill="#003087"/><path d="M16.5 7.5H20.8C23.2 7.5 24.5 8.6 24.5 10.8C24.5 12.5 23.5 13.8 21.8 14.2L21.2 14.2L20.5 18.5H17.5L18.5 12.5H16.5L16.5 7.5Z" fill="#009cde" transform="translate(4,0)"/></svg>
          </div>
          <div class="payment-icon" title="Diners Club">
            <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg"><rect width="38" height="24" fill="white"/><circle cx="14" cy="12" r="6" fill="#004A97"/><circle cx="24" cy="12" r="6" fill="#004A97"/><path d="M14 8C11.8 8 10 9.8 10 12C10 14.2 11.8 16 14 16C16.2 16 18 14.2 18 12C18 9.8 16.2 8 14 8ZM24 8C21.8 8 20 9.8 20 12C20 14.2 21.8 16 24 16C26.2 16 28 14.2 28 12C28 9.8 26.2 8 24 8Z" fill="white"/><path d="M19 8C16.8 8 15 9.8 15 12C15 14.2 16.8 16 19 16C21.2 16 23 14.2 23 12C23 9.8 21.2 8 19 8Z" fill="#004A97"/></svg>
          </div>
          <div class="payment-icon" title="Discover">
            <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg"><rect width="38" height="24" fill="white"/><text x="50%" y="55%" dominant-baseline="middle" text-anchor="middle" font-family="Arial, sans-serif" font-weight="bold" font-size="10" fill="#FF6600">DISCOVER</text></svg>
          </div>
        </div>
      </div>
    </div>
